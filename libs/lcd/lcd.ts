namespace LCD {
     ...
     */
    //% blockId="lcd_rgb" block="red %red|green %green|blue %blue"
    ...
    //% blockId="lcd_hsv" block="hue %hue|sat %sat|val %val"
    //% hue.min=0 hue.max=255 sat.min=0 sat.max=255 val.min=0 val.max=255
    //% help="light/hsv"
    //% group="Backlight" weight=17
     ...
     */
    //% blockId="lcd_fade" block="fade %color=colorNumberPicker|by %brightness"
    //% brightness.min=0 brightness.max=255
    //% help="light/fade"
    //% group="Backlight" weight=16 blockGap=8
